      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <h2 style={{ fontSize: '1.25rem', fontWeight: 700 }}>Your Food Cart</h2>
          </div>
          <button
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '20px 24px' }}>
          {cart.length === 0 ? (
            <div style={{ textAlign: 'center', padding: '60px 20px', color: 'var(--text-secondary)' }}>
              <ShoppingBag size={54} color="#334155" style={{ marginBottom: '16px' }} />
              <h3 style={{ fontSize: '1.15rem', marginBottom: '8px', color: '#f8fafc' }}>Your cart is empty</h3>
        ...
        {cart.length > 0 && (
          <div style={{
            ...
            {subtotal < 499 ? (
              <div style={{ marginBottom: '16px', fontSize: '0.82rem', color: '#fb923c', textAlign: 'center', background: 'rgba(249, 115, 22, 0.1)', padding: '8px', borderRadius: '8px' }}>
                Add <b>₹{499 - subtotal}</b> more for <b>FREE Delivery</b>!
              </div>
            ) : (
              <div style={{ marginBottom: '16px', fontSize: '0.82rem', color: '#34d399', textAlign: 'center', fontWeight: 700, background: 'rgba(16, 185, 129, 0.1)', padding: '8px', borderRadius: '8px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '18px', fontSize: '0.9rem' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', color: 'var(--text-secondary)' }}>
                ...
                <span>{deliveryFee === 0 ? <strong style={{ color: '#34d399' }}>FREE</strong> : `₹${deliveryFee}`}</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', color: 'var(--text-secondary)' }}>
